...
Select Case index
    Case 0
        ...
        End Select
       Call Engine.GrhRenderToHdc(UserBancoInventory(List1(0).ListIndex + 1).grhindex, Picture1.hdc, 0, 0)
    Case 1
        ...
        Select Case Inventario.OBJType(List1(1).ListIndex + 1)
            ...
            Case Else
                ...
                Label1(4).Visible = False
        End Select
              Call Engine.GrhRenderToHdc(Inventario.grhindex(List1(1).ListIndex + 1), Picture1.hdc, 0, 0)
End Select
Picture1.Refresh
