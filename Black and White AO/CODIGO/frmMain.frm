...
If MsgBox("¿Esta Seguro/a que desea Salir del juego?", vbYesNo + vbQuestion, "Black and White AO") = vbYes Then
Call SendData("/SALIR")
Else
            Exit Sub
        End If
    ...
    Select Case KeyCode
        ...
        Case CustomKeys.BindedKey(eKeyType.mKeyToggleFPS)
                ...
                If Not FPSFLAG Then _
                    frmMain.Caption = "Black And White AO"
