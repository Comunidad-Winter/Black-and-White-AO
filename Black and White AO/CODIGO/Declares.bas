...
Public NameRelogueo As String
Public PassRelogueo As String
...
Public Const tAt = 150   'Intervalo hechi
Public Const tUs = 600 'intervalo pots
...
Public Const MENSAJE_USAR_MEDITANDO As String = "No puedes usar items mientras estas meditando"
