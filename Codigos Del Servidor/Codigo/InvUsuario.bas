...
Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CLA" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Aura)
    ...
    Case eOBJType.otArmadura
        ...
        Call ChangeUserChar(SendTarget.ToMap, 0, UserList(UserIndex).Pos.Map, UserIndex, UserList(UserIndex).Char.Body, UserList(UserIndex).Char.Head, UserList(UserIndex).Char.Heading, UserList(UserIndex).Char.WeaponAnim, UserList(UserIndex).Char.ShieldAnim, UserList(UserIndex).Char.CascoAnim)
         ...
         UserList(UserIndex).Char.Aure = 0
        Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CLO" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Aure)
    ...
    Case eOBJType.otCASCO
        ...
        UserList(UserIndex).Char.Auro = 0
        Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CLU" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Auro)
    ...
    Case eOBJType.otESCUDO
        ...
        If Not UserList(UserIndex).flags.Mimetizado = 1 Then
            ...
            Call ChangeUserChar(SendTarget.ToMap, 0, UserList(UserIndex).Pos.Map, UserIndex, UserList(UserIndex).Char.Body, UserList(UserIndex).Char.Head, UserList(UserIndex).Char.Heading, UserList(UserIndex).Char.WeaponAnim, UserList(UserIndex).Char.ShieldAnim, UserList(UserIndex).Char.CascoAnim)
        End If
        UserList(UserIndex).Char.Aurt = 0
        Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CLT" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Aurt)
...
Select Case Obj.OBJType
    ...
    If UserList(UserIndex).flags.Metamorfosis = 1 Then Exit Sub  'Metamorfosis
        ...
        If ClasePuedeUsarItem(UserIndex, UserList(UserIndex).Invent.Object(Slot).ObjIndex) And _
           ...
           'Si esta equipado lo quita
            ...
            UserList(UserIndex).Char.Aure = Obj.Aure
            Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CLO" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Aure)
    ...
    If UserList(UserIndex).flags.Metamorfosis = 1 Then Exit Sub  'Metamorfosis
        ...
        Or UserList(UserIndex).flags.Privilegios >= PlayerType.Dios Then
            ...
            UserList(UserIndex).Char.Auro = Obj.Auro
            Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CLU" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Auro)
        ...
        If UserList(UserIndex).flags.Navegando = 1 Then Exit Sub
         If ClasePuedeUsarItem(UserIndex, UserList(UserIndex).Invent.Object(Slot).ObjIndex) And _
          FaccionPuedeUsarItem(UserIndex, UserList(UserIndex).Invent.Object(Slot).ObjIndex) Or UserList(UserIndex).flags.Privilegios >= PlayerType.Dios Then
             ...
             UserList(UserIndex).Char.Aurt = Obj.Aurt
            Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CLT" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Aurt)
...
If Obj.OBJType = otScrollIntermundia Then
...
Case eOBJType.otRuna
            ...
            If UCase$(UserList(UserIndex).Hogar) = "ULLATHORPE" Then
                ...
                Call SendData(SendTarget.ToIndex, UserIndex, 0, "||Has llegado a Ullathorpe" & FONTTYPE_INFO)
            ElseIf UCase$(UserList(UserIndex).Hogar) = "NIX" Then
                Call WarpUserChar(UserIndex, 34, 44, 88, True)
                Call SendData(SendTarget.ToIndex, UserIndex, 0, "||Has llegado a Nix" & FONTTYPE_INFO)
            ElseIf UCase$(UserList(UserIndex).Hogar) = "BANDERBILL" Then
                Call WarpUserChar(UserIndex, 59, 50, 50, True)
                Call SendData(SendTarget.ToIndex, UserIndex, 0, "||Has llegado a Banderbill" & FONTTYPE_INFO)
            ElseIf UCase$(UserList(UserIndex).Hogar) = "LINDOS" Then
                Call WarpUserChar(UserIndex, 62, 72, 41, True)
                Call SendData(SendTarget.ToIndex, UserIndex, 0, "||Has llegado a Lindos" & FONTTYPE_INFO)
            End If
Case eOBJType.OtPOTSREMO
...
Call SendData(SendTarget.ToIndex, UserIndex, 0, "||Te has echo invisible." & FONTTYPE_INFO)
        Call QuitarUserInvItem(UserIndex, Slot, 1)
        Call UpdateUserInv(False, UserIndex, Slot)
End If 'Athan Rlz
...
For i = 1 To MAX_INVENTORY_SLOTS
If UserList(UserIndex).Invent.Object(i).ObjIndex = PiedraIndex Then
If DestruirPiedraMagica = 0 Then
NuevaPos.X = 0: NuevaPos.Y = 0
MiObj.Amount = UserList(UserIndex).Invent.Object(i).Amount: MiObj.ObjIndex = PiedraIndex
