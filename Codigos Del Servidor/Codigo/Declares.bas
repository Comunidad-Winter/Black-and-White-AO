...
Public Const PiedraIndex As Integer = 856
Public Const DestruirPiedraMagica As Byte = 0
...
Public Const ANILLOESPECTRAL As Integer = 862
...
Public Enum eOBJType
    ...
    OtPOTSINVI = 37
    OtPOTSREMO = 38
    otPasaje = 36 'Mithrandir - Pasaje
    otScrollIntermundia = 40
    otRuna = 41
    otMetaPot = 666 'Metamorfosis
    otCualquiera = 1000
End Enum

'Texto
Public Const FONTTYPE_CONSOLA As String = "~0~128~128~0~0"
Public Const FONTTYPE_GLOBAL As String = "~0~255~255~0~0"
...
Public Const FONTTYPE_HABLAEVENTO As String = "~213~210~131~1~0"
Public Const FONTTYPE_PRIVADO As String = "~0~255~0~0~1"

'Estadisticas
Public STAT_MAXELV As Integer
...
Aura As Integer
    ...
    Valor As Long     ' Precio
        'Pasaje - Mithradir
    DesdeMapa As Integer
    HastaMapa As Integer
    HastaY As Integer
    HastaX As Integer
    'Pasaje de Mithrandir :$
...
Public Const RYKAN As Integer = 872 'objeto segun obj.dat
