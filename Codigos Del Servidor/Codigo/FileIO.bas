...
For Hechizo = 1 To NumeroHechizos
    ...
    Hechizos(Hechizo).PART = val(Leer.GetValue("Hechizo" & Hechizo, "PART"))
...
For Object = 1 To NumObjDatas
    ...
    ObjData(Object).Aurt = val(Leer.GetValue("OBJ" & Object, "CreaAurt"))
    ObjData(Object).Aure = val(Leer.GetValue("OBJ" & Object, "CreaAure"))
    ObjData(Object).Auro = val(Leer.GetValue("OBJ" & Object, "CreaAuro"))
    ...
    ObjData(Object).Valor = val(Leer.GetValue("OBJ" & Object, "Valor"))
        'Pasaje Mithrandir
    ObjData(Object).DesdeMapa = val(Leer.GetValue("OBJ" & Object, "DesdeMapa"))
    ObjData(Object).HastaMapa = val(Leer.GetValue("OBJ" & Object, "HastaMapa"))
...
STAT_MAXELV = val(GetVar(DatPath & "Configuracion", "USUARIOS", "NivelMaximo"))
If STAT_MAXELV <= 0 Or STAT_MAXELV >= 1001 Then STAT_MAXELV = 200
