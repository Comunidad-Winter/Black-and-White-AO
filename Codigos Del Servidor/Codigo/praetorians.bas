...
On Error GoTo errorh
    ...
    Call SendData(SendTarget.ToNPCArea, NPCAlInd, Npclist(NPCAlInd).Pos.Map, "CFX" & Npclist(NPCAlInd).Char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops)
            Call SendData(SendTarget.ToNPCArea, NPCAlInd, Npclist(NPCAlInd).Pos.Map, "CFF" & Npclist(NPCAlInd).Char.CharIndex & "," & Hechizos(indireccion).PART & "," & Hechizos(indireccion).loops)
...
On Error GoTo errorh
    ...
    Call SendData(SendTarget.ToNPCArea, Paralizado, Npclist(Paralizado).Pos.Map, "CFX" & Npclist(Paralizado).Char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops)
            Call SendData(SendTarget.ToNPCArea, Paralizado, Npclist(Paralizado).Pos.Map, "CFF" & Npclist(Paralizado).Char.CharIndex & "," & Hechizos(indireccion).PART & "," & Hechizos(indireccion).loops)
...
On Error GoTo errorh
    ...
    Call SendData(SendTarget.ToNPCArea, curado, Npclist(curado).Pos.Map, "CFX" & Npclist(curado).Char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops)
            Call SendData(SendTarget.ToNPCArea, curado, Npclist(curado).Pos.Map, "CFF" & Npclist(curado).Char.CharIndex & "," & Hechizos(indireccion).PART & "," & Hechizos(indireccion).loops)
...
On Error GoTo errorh
    ...
    Call SendData(SendTarget.ToPCArea, PJEnInd, UserList(PJEnInd).Pos.Map, "CFX" & UserList(PJEnInd).Char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops)
            Call SendData(SendTarget.ToPCArea, PJEnInd, UserList(PJEnInd).Pos.Map, "CFF" & UserList(PJEnInd).Char.CharIndex & "," & Hechizos(indireccion).PART & "," & Hechizos(indireccion).loops)
...
On Error GoTo errorh
    ...
    Call SendData(SendTarget.ToPCArea, PJEnInd, UserList(PJEnInd).Pos.Map, "CFX" & UserList(PJEnInd).Char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops + 4)
        Call SendData(SendTarget.ToPCArea, PJEnInd, UserList(PJEnInd).Pos.Map, "CFF" & UserList(PJEnInd).Char.CharIndex & "," & Hechizos(indireccion).PART & "," & Hechizos(indireccion).loops + 4)
                ...
                For Y = 8 To 95
                    ...
                    If PJInd > 0 Then
                        ...
                        Call SendData(SendTarget.ToPCArea, PJInd, UserList(PJInd).Pos.Map, "CFX" & UserList(PJInd).Char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops)
                                                                        Call SendData(SendTarget.ToPCArea, PJInd, UserList(PJInd).Pos.Map, "CFF" & UserList(PJInd).Char.CharIndex & "," & Hechizos(indireccion).PART & "," & Hechizos(indireccion).loops)
                    ...
                    ElseIf (MascotaInd > 0) Then
                        If (Npclist(MascotaInd).MaestroUser > 0) Then
                            ...
                            Call SendData(SendTarget.ToNPCArea, MascotaInd, Npclist(MascotaInd).Pos.Map, "CFX" & Npclist(MascotaInd).Char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops)
                                                        Call SendData(SendTarget.ToNPCArea, MascotaInd, Npclist(MascotaInd).Pos.Map, "CFF" & Npclist(MascotaInd).Char.CharIndex & "," & Hechizos(indireccion).PART & "," & Hechizos(indireccion).loops)
