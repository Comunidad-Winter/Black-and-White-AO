...
Public Function PuedeFundarUnClan(ByVal UserIndex As Integer, ByVal Alineacion As ALINEACION_GUILD, ByRef refError As String) As Boolean
    ...
    If UserList(UserIndex).Stats.ELV < 40 Or Not TieneObjetos(877, 5, UserIndex) Then
        refError = "Para fundar un clan debes ser nivel 40 y poseer la Orbe de fundacion."
        Exit Function
    End If
